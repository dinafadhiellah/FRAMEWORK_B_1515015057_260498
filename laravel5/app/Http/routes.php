...
Route::get('ruangan/{ruangann}','RuanganController@lihat');
Route::post('ruangan/simpan','RuanganController@simpan');
Route::get('ruangan/edit/{ruangann}','RuanganController@edit');
Route::post('ruangan/edit/{ruangann}','RuanganController@update');
Route::get('ruangan/hapus/{ruangann}','RuanganController@hapus');
